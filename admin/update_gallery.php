<?php
    ...
    if (isset($_POST['BtnUpdate']))
    {
        ...
        $query = "UPDATE gallery SET title = '$Title', description = '$Description', image = '$location'   WHERE id = '$id'";
...
?>
        <script>
            ...
            window.location.href='gallery.php?success';
            </script>
<?php
    }
    else
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    $Query = "SELECT  title,description,image  FROM gallery  WHERE id = ".$id;

<?php
    ...
    if (isset($_POST['BtnUpdate']))
    {
        ...
        $query = "UPDATE experts SET title = '$Title', description = '$Description', image = '$location'   WHERE id = '$id'";
...
?>
        <script>
            ...
            window.location.href='experts.php?success';
            </script>
<?php
    }
    else
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    $Query = "SELECT  title,description,image  FROM experts  WHERE id = ".$id;
                                        ...
                                        <form action="#" method="post" enctype="multipart/form-data">
                                             <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    placeholder="Description " class="form-control" id="ss" value="<?php echo $row['description'];?>">
                                                </div>

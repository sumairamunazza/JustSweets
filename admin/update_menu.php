<?php
    ...
    if (isset($_POST['BtnUpdate']))
    {
        ...
        $Price = $_REQUEST['BtnPrice'];

        $query = "UPDATE menu SET  title = '$Title',description = '$Description', Price = '$Price', image = '$location'   WHERE id = '$id'";
...
?>
        <script>
            ...
            window.location.href='menu.php?success';
            </script>
<?php
    }
    else
                                ...
                                ?>
                                        <form action="#" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="BtnPrice" parsley-trigger="change" required
                                                    placeholder="title " class="form-control" id="rew" value="<?php echo $row['price'];?>">
                                                </div>

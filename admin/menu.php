...
<?php
     if(isset($_REQUEST['BtnSubmit']))
    {
        ...
        $Query = "INSERT INTO menu ".
                   "(title, description ,price ,image) "."VALUES ".
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <div class="card-box">
                                <center>
                                    <h4 class="header-title m-t-0">Menu</h4>
                                    </center>
                                    <div class="container">
                                        <form action="#" method="post" enctype="multipart/form-data">
                                             <div class="form-group">
                                               ...
                                               <div class="form-group">
                                                    ...
                                                    placeholder="Price" class="form-control" id="userName">
                                        ...
                                        ?>      
                                                    <tr>
                                                       <td><?php echo $row['title']; ?></td>
                                                        ...
                                                        <td><a href="update_menu.php?id=<?php echo $row['id']; ?>">Edit</a>
                                                            </td>
                                                        <td><a href="delete_menu.php?id=<?php echo $row['id']; ?>" 

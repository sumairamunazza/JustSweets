                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <div class="card-box">
                                <center>
                                    <h4 class="header-title m-t-0">Best Seller </h4>
                                    </center>
                                    <div class="container">
                        ...
                        <table class="table table-hover">
                                        ...
                                        ?>      
                                                    <tr>
                                                        ...
                                                        <td><a href="update_best_seller.php?id=<?php echo $row['id']; ?>">Edit</a>
                         
                                                        <td><a href="delete_best_seller.php?id=<?php echo $row['id']; ?>" 
